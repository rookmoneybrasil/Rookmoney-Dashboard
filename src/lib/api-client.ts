...
export const clientApi = {
  ...
  createPersonRecurring: (data: { personId: string; type: string; description: string; amount: number; dayOfMonth?: number; firstDate?: string | null; notes?: string | null; categoryId?: string | null; accountId?: string | null }) =>
    clientFetch<PersonEntryRecurringItem>('/people/recurring', { method: 'POST', body: JSON.stringify(data) }),
  updatePersonRecurring: (id: string, data: { description?: string; amount?: number; dayOfMonth?: number; categoryId?: string | null; notes?: string | null; isActive?: boolean; accountId?: string | null }) =>
  ...
  deleteAccount: (data?: { reason?: string; feedback?: string }) =>
    clientFetch<void>('/settings', { method: 'DELETE', body: JSON.stringify(data ?? {}) }),
...
export interface Transaction { id: string; amount: number; type: 'INCOME' | 'EXPENSE'; description: string | null; date: string; category: Category; categoryId: string; userId: string; createdAt: string; updatedAt: string; accountId?: string | null; account?: { id?: string; name: string; icon: string; color: string } | null; ignored?: boolean }
export interface TransactionInput { amount: number; type: 'INCOME' | 'EXPENSE'; description: string; date: string; categoryId: string; accountId?: string; ignored?: boolean }
...
export interface PersonEntryRecurringItem { id: string; type: 'THEY_OWE_ME' | 'I_OWE_THEM'; description: string; amount: number; dayOfMonth: number; isActive: boolean; notes: string | null; lastMonth: string | null; startMonth: string | null; personId: string; person: { id: string; name: string; color: string | null }; categoryId: string | null; category: { id: string; name: string; icon: string; color: string } | null; accountId: string | null; account: { id: string; name: string; icon: string; color: string } | null; createdAt: string }
export interface PersonEntry { id: string; type: 'THEY_OWE_ME' | 'I_OWE_THEM'; description: string; amount: number; date: string; isSettled: boolean; settledAt: string | null; notes: string | null; installmentTotal: number | null; installmentCurrent: number | null; installmentGroupId: string | null; settledTransactionId: string | null; recurringEntryId: string | null; category: { id: string; name: string; icon: string; color: string } | null; categoryId: string | null; accountId: string | null; account: { id: string; name: string; icon: string; color: string } | null; personId: string; userId: string; createdAt: string; updatedAt: string }
