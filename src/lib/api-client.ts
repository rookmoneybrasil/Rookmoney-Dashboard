...
export interface PersonEntryRecurringItem { id: string; type: 'THEY_OWE_ME' | 'I_OWE_THEM'; description: string; amount: number; dayOfMonth: number; isActive: boolean; notes: string | null; lastMonth: string | null; startMonth: string | null; personId: string; person: { id: string; name: string; color: string | null }; categoryId: string | null; category: { id: string; name: string; icon: string; color: string } | null; createdAt: string }
