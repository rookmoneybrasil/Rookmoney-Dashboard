      ...
      <header className="sticky top-0 z-50 border-b border-white/6 bg-ink-900/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/login"    className="text-sm font-medium text-slate-400 hover:text-slate-100 transition-colors px-3 py-1.5">Entrar</Link>
            <Link href="/register" className="text-sm font-medium bg-brand-600 hover:bg-brand-500 text-white px-4 py-2 rounded-lg transition-colors">Começar grátis</Link>
          </div>
        </div>
      </header>
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left flex-1 min-w-0 pt-4 lg:pt-0">
              ...
              <FadeIn delay={320}>
                <p className="mt-5 text-lg text-slate-400 max-w-lg leading-relaxed">
                  Dashboard inteligente, metas, orçamento por categoria e relatórios detalhados.
