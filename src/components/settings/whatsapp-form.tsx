...
import { saveWhatsAppPhone } from '@/app/actions/whatsapp'
...
export function WhatsAppForm({ currentPhone }: Props) {
  const [state, formAction, pending] = useActionState(saveWhatsAppPhone, undefined)
      ...
      <div className="flex flex-col gap-4">
        ...
        <form action={formAction}>
          ...
          >
            ...
            {pending ? 'Removendo...' : 'Desvincular número'}
          </button>
        </form>
      </div>
    )
