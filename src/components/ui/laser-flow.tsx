...
export default function LaserFlow({
  ...
  useEffect(() => {
    ...
    const uniforms: Record<string, THREE.IUniform> = {
      ...
      uFade:             { value: fadedRef.current ? 1 : 0 },
    }
    ...
    let prevT = 0, fade = fadedRef.current ? 1 : 0
    ...
    const loop = () => {
      ...
      const dt = Math.min(0.033, Math.max(0.001, t - prevT)); prevT = t
      ...
      if (!fadedRef.current) {
        ...
        if (fade >= 1) fadedRef.current = true
      }
