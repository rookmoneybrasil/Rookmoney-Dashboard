...
export function BorderGlow({
  ...
  useEffect(() => {
    ...
    animateValue({ ease: easeInCubic,  duration: 1500, end: 50,  onUpdate: v => card.style.setProperty('--cursor-angle', `${(465 - 110) * (v / 100) + 110}deg`) })
    animateValue({ ease: easeOutCubic, delay: 1500, duration: 2250, start: 50, end: 100, onUpdate: v => card.style.setProperty('--cursor-angle', `${(465 - 110) * (v / 100) + 110}deg`) })
