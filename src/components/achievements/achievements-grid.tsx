          ...
          <div key={category}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
              {items.map(a => {
                ...
                try { tip  = ti(`${a.slug}.tip`)  } catch { tip  = '' }
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      a.unlocked
                        ...
                        : 'bg-ink-900/60 border-white/4 opacity-60',
                  ...
                  >
                    ...
                    <p className={cn(
                      ...
                      a.unlocked ? 'text-slate-200' : 'text-slate-500',
                    )}>
                      {name}
                    </p>

                    <p className={cn(
                      'text-[11px] leading-snug mt-1 line-clamp-3',
                      a.unlocked ? 'text-slate-500' : 'text-slate-600',
                    )}>
                      {tip}
                    </p>
